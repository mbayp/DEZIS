...
class OrderHistoryAdapter :
    ListAdapter<Treatment, OrderHistoryAdapter.OrderHistoryViewHolder>(OrderHistoryDiffCallback()) {
    ...
    inner class OrderHistoryViewHolder(private val binding: ItemServiceCardBinding) :
...
internal class OrderHistoryDiffCallback : DiffUtil.ItemCallback<Treatment>() {
