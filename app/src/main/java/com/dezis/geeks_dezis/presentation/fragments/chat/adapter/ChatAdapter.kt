//закомичен прошлый код это болванка для показа
...
class ChatAdapter : ListAdapter<ChatModel, ChatAdapter.MessageViewHolder>(MessageDiffCallback()) {
    ...
    private fun getDummyChatData(): List<ChatModel> {
        return listOf(
            ...
            ChatModel(id = 3, fromUserId = "User1", message = "How are you?", timestamp = "10:17 AM"),
            ChatModel(id = 4, fromUserId = "User2", message = "I'm good, thanks!", timestamp = "10:18 AM"),
            ChatModel(id = 5, fromUserId = "User1", message = "Great to hear!", timestamp = "10:19 AM")
        )
    }
}
